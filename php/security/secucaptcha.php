...
$fileorig = file_get_contents(__DIR__.'/../../cache/waf-botcaptcha.html');

//Get the count of topic read
$file = file_get_contents(__DIR__.'/../../cache/wafcn-cap.html');
...
$atkdt = explode("\n", $file);
	...
	foreach($atkdt as $flood) {
		...
		if((int)$value[2] > 10 && strlen($value[3]) > 3 && $value[3] != 'New' && $value[3] != 'Reply') {
				...
				file_put_contents(__DIR__.'/../../cache/waf-botcaptcha.html', $replace);
